...
namespace BestPathUI.services
{
    ...
    public class AuthService : IAuthService
    {
        ...
        public async Task<RegisterResult> Register(RegisterModel registerModel)
        {
            ...
            var response = await _httpClient.PostAsJsonAsync("api/accounts", new StringContent(registerAsJson, Encoding.UTF8, "application/json"));
